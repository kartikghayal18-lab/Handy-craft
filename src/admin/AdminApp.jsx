...
import { getOrders, getPersonalizationOrders, notifyOrderStatusUpdate, updateOrderStatus } from '../lib/supabase/orders';
import { getCustomers } from '../lib/supabase/customers';
import { getPersonalizationSignedUrl } from '../lib/supabase/storage';
...
function PersonalizationPhotoLink({asset,index,total}){
  ...
  const reveal=async()=>{
    ...
    catch(err){setState({loading:false,url:'',error:'Photo unavailable'});return null;}
  };
  ...
  const download=async()=>{
    ...
    try{
      ...
      link.href=blobUrl;link.download=asset.original_filename||'personalization-photo';
