...
function Checkout({cart, close, complete}) {
  ...
  const place=async event=>{
    ...
    if(required.some(key=>!form[key].trim())){setError('Please complete your name, phone, email, address, city, state, and postal code.');return;}
